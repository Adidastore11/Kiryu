...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                          ©XW∆N STORE©             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="http://myrid.digital/kentang/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/myridwan/izinvps/ipuk/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/myridwan/izinvps/ipuk/ip | grep $ipsaya | awk '{print $3}')
...
wget http://myrid.digital/kentang/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd /bin
git clone  https://github.com/F4-RIS/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
